...
const RomanticApp = () => {
  ...
  const [isBushra, setIsRania] = useState(false);
  ...
  const handleNameSubmit = () => {
    setIsRania(name.toLowerCase() === 'bushra');
    setView('feedback');
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 to-pink-900 flex flex-col items-center justify-center p-4 overflow-hidden">
      ...
      <AnimatePresence mode='wait'>
        {view === 'name' && (
          ...
          >
                    <h1 className="text-amber-50 relative bottom-2.5 text-2xl font-bold "> Type Correct Name Like Abdullah</h1>
